package com.xiarh.aireader.utils;
...
public class DBUtils {
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, Config.WANGYI));
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, Config.ZHIHU));
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, Config.MEIZI));
        }
